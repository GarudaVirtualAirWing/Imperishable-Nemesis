...
----------------------------------------------------
-- REQUIRED MIST (MISSION SCRIPTING TOOLS)         |
--
----------------------------------------------------
...
ctld.buildTimeFOB = 100 --time in seconds for the FOB to be built
...
ctld.AASystemLimitRED = 50 -- Red side limit

ctld.AASystemLimitBLUE = 50 -- Blue side limit
...
ctld.pickupZones = {
	-- STORM EAGLE PACKAGE --
	{ "Batumi Pickzone", "blue", -1, "yes", 0 },
	{ "Kobuleti Pickzone", "blue", -1, "yes", 0 },
	{ "Senaki Pickzone", "red", -1, "yes", 0 },
	{ "Kutaisi Pickzone", "red", -1, "yes", 0 },
	{ "London Pickzone", "blue", -1, "yes", 0 },
	{ "Dallas Pickzone", "blue", -1, "yes", 0 },
	{ "Paris Pickzone", "blue", -1, "yes", 0 },
	{ "Sukhumi Pickzone", "blue", -1, "yes", 0 },
